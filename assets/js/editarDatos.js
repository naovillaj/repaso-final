 ...
 if(localStorage.getItem("nuevoCoder")){
        ...
        naame.value = objetoCoder.nombre;
        lastName.value = objetoCoder.apellido;
        email.value = objetoCoder.correo;
        password.value = objetoCoder.contraseña;
...
limpiar.addEventListener('click', function(e){
      //e.preventDefault();
  localStorage.removeItem("nuevoCoder");
